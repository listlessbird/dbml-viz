/* eslint-disable */
// Generated by Wrangler by running `wrangler types -c wrangler.json -c wrangler.parser.json` (hash: 32cb8fa51ad4561c57cbcf00c6dd8379)
...
declare namespace Cloudflare {
	interface GlobalProps {
		...
		durableNamespaces: "SchemaSessionDO";
	}
	interface Env {
		SCHEMAS: KVNamespace;
		SESSIONS: DurableObjectNamespace<import("./src/worker/index").SchemaSessionDO>;
