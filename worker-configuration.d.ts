/* eslint-disable */
// Generated by Wrangler by running `wrangler types -c wrangler.json -c wrangler.parser.json` (hash: 567ed56ddee9e50866daebe728383e21)
// Runtime types generated with workerd@1.20251217.0 2026-04-02 nodejs_compat
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/worker/index");
		durableNamespaces: "SchemaWorkspace";
	}
	interface Env {
		SCHEMAS: KVNamespace;
		VITE_ENABLE_DEV_OVERLAYS: string;
		SchemaWorkspace: DurableObjectNamespace<import("./src/worker/index").SchemaWorkspace>;
		SCHEMA_PARSER: Service<typeof import("./src/parser-worker/index").default>;
	}
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "VITE_ENABLE_DEV_OVERLAYS">> {}
}
